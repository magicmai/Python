...
print "7. False and 0 != 1:", False and 0 != 1
...
print "17. not ('testing' == 'testing' and 'Zed' == 'Cool Guy'):", not ('testing' == 'testing' and 'Zed' == 'Cool Guy')

print "18. 1 == 1 and not ('testing' == 1 or 1 == 0):", 1 == 1 and not ('testing' == 1 or 1 == 0)

print "19. 'chunck' == 'bacon' and not (3 == 4 or 3 == 3):", 'chunck' == 'bacon' and not (3 == 4 or 3 == 3)
